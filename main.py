...
def process_and_train(generator, output_path, create_hdf5, model, fit_trials=50, return_test=False):
    ...
    if return_test:
        return f1, model_instance, X_test, y_test
...
#---------------------------------------------------------------------------------------------#
    ...
    if ext_tech != "best_feature":
        ...
        # )
        # _, svm_model, _, _ = process_and_train(generator_svm, output_path, False, model="svm", fit_trials=50, return_test=True)
